...
- Site set exposing `tca_api_headless.enabled` and `tca_api_headless.basePath`.

[Unreleased]: https://github.com/maikschneider/tca-api-headless/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/maikschneider/tca-api-headless/releases/tag/v0.1.0
